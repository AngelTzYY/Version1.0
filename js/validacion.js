...
function validar_contraseña() {
    ...
    if (password === "") {
        ...
        errorMessagePassword.textContent = "Por favor ingrese una contraseña";
        confirmPassword.disabled = false; // Mantener habilitado para poder ingresar confirmación
    ...
    // Verificar que la contraseña contenga al menos una letra y un dígito
    var hasLetter = false;
    var hasDigit = false;
...
// Evento para habilitar/deshabilitar el campo de confirmar contraseña
document.getElementById("password").addEventListener("input", function() {
    validar_contraseña();
});

document.getElementById("confirmPassword").addEventListener("input", validar_contraseña);

// Asegurarse de que el campo de confirmación esté habilitado inicialmente
...
function validar_correo() {
    ...
    // Verificar si el campo está vacío (sin eliminar espacios)
    if (correo.trim() === "") {
        ...
        // Mantener los espacios en blanco al validar el formato del correo
